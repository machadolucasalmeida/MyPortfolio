...
export class Main {
  ...
  projectLinks: string[] = ['https://google.com', 'https://youtube.com', 'https://facebook.com', 'https://instagram.com'];
  repositorytLinks: string[] = ['https://github.com', 'https://github.com', 'https://github.com', 'https://github.com'];
